...
exports.takiptenCikildi = functions.firestore
  ...
  .onDelete(async (snapshot, context) => {
    ...
    const gonderilerSnapshot = await admin
      ...
      .doc(takipEdenId)
      .collection("kullaniciAkisGonderileri")
      .where("yayinlayanId", "==", takipEdilenId)
      .get();
...
exports.yeniGonderiEklendi = functions.firestore
  .document(
    "gonderiler/{takipEdilenKullaniciId}/kullaniciGonderileri/{gonderiId}"
  )
  .onCreate(async (snapshot, context) => {
    ...
    const takipcilerSnapshot = await admin
      .firestore()
