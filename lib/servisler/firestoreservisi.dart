...
class FireStoreServisi {
  ...
  Future<void> gonderiSil({String aktifKullaniciId, Gonderi gonderi}) async {
    ...
    Future<void> gonderiBegen(Gonderi gonderi, String aktifKullaniciId) async {
      ...
      DocumentSnapshot doc = await docRef.get(); //dokümana ulastım
      ...
      if (doc.exists) {
        ...
        }); //ulastıgım dokumanın begeni sayısını guncelledim

        //kullanıcı-gonderi ilişkisini beğeniler koleksiyonuna ekle
        _firestore
            ...
            .document(aktifKullaniciId)
            .setData({});
      } //belge kimliği aktif kullanıcı id olan bir doküman eklemiş olduk
    ...
    Future<void> gonderiBegeniKaldir(
      ...
      if (doc.exists) {
        ...
        //kullanıcı - gönderi ilişkisini beğeniler koleksiyonundan silme
