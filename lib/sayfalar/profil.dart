...
import 'package:flutterclone/sayfalar/profiliDuzenle.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[
          widget.profilSahibiId == _aktifKullaniciId ? IconButton(
              icon: Icon(
                Icons.exit_to_app,
                color: Colors.black,
              ),
              onPressed: _cikisYap) : SizedBox(height: 0.0,)
        ],
            ...
            children: <Widget>[
              CircleAvatar(
                ...
                backgroundImage: profilData.fotoUrl.isNotEmpty
                    ...
                    : AssetImage("assets/images/adam.png"),
              ),
              Expanded(
                child: Row(
