...
import 'package:flutterclone/sayfalar/yorumlar.dart';
      ...
      leading: Padding(
        ...
        child: GestureDetector(
          onTap: (){
            ...
            backgroundImage: widget.yayinlayan.fotoUrl.isNotEmpty ? NetworkImage(widget.yayinlayan.fotoUrl) : AssetImage("assets/images/adam.png"),
          ),
        ),
      ),
